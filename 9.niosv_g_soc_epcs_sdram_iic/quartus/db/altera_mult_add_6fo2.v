//altera_mult_add CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEDICATED_MULTIPLIER_CIRCUITRY="YES" DEVICE_FAMILY="Cyclone IV E" DSP_BLOCK_BALANCING="Auto" INPUT_A0_LATENCY_ACLR="NONE" INPUT_A0_LATENCY_CLOCK="CLOCK0" INPUT_ACLR_A0="NONE" INPUT_ACLR_B0="NONE" INPUT_B0_LATENCY_ACLR="NONE" INPUT_B0_LATENCY_CLOCK="CLOCK0" INPUT_REGISTER_A0="UNREGISTERED" INPUT_REGISTER_B0="UNREGISTERED" INPUT_SOURCE_A0="DATAA" INPUT_SOURCE_B0="DATAB" LATENCY=0 MULTIPLIER_ACLR0="NONE" MULTIPLIER_REGISTER0="CLOCK0" NUMBER_OF_MULTIPLIERS=1 OUTPUT_ACLR="NONE" OUTPUT_REGISTER="UNREGISTERED" port_signa="PORT_USED" port_signb="PORT_USED" SELECTED_DEVICE_FAMILY="Cyclone IV E" SIGNED_ACLR_A="NONE" SIGNED_ACLR_B="NONE" SIGNED_LATENCY_ACLR_A="NONE" SIGNED_LATENCY_ACLR_B="NONE" SIGNED_LATENCY_CLOCK_A="CLOCK0" SIGNED_LATENCY_CLOCK_B="CLOCK0" SIGNED_REGISTER_A="UNREGISTERED" SIGNED_REGISTER_B="UNREGISTERED" WIDTH_A=32 WIDTH_B=32 WIDTH_RESULT=64 clock0 dataa datab result signa signb
...
`endif
	...
	assign
		result = wire_altera_mult_add_rtl1_result;
endmodule //altera_mult_add_6fo2
//VALID FILE
