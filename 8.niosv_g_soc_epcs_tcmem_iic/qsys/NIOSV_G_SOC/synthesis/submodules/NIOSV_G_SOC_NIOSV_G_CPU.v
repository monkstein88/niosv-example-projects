...
`timescale 1 ps / 1 ps
module NIOSV_G_SOC_NIOSV_G_CPU (
		...
		input  wire [14:0] instruction_tcs1_awaddr,      //    instruction_tcs1.awaddr
		input  wire [2:0]  instruction_tcs1_awprot,      //                    .awprot
		input  wire        instruction_tcs1_awvalid,     //                    .awvalid
		output wire        instruction_tcs1_awready,     //                    .awready
		input  wire [31:0] instruction_tcs1_wdata,       //                    .wdata
		input  wire [3:0]  instruction_tcs1_wstrb,       //                    .wstrb
		input  wire        instruction_tcs1_wvalid,      //                    .wvalid
		output wire        instruction_tcs1_wready,      //                    .wready
		output wire [1:0]  instruction_tcs1_bresp,       //                    .bresp
		output wire        instruction_tcs1_bvalid,      //                    .bvalid
		input  wire        instruction_tcs1_bready,      //                    .bready
		input  wire [14:0] instruction_tcs1_araddr,      //                    .araddr
		input  wire [2:0]  instruction_tcs1_arprot,      //                    .arprot
		input  wire        instruction_tcs1_arvalid,     //                    .arvalid
		output wire        instruction_tcs1_arready,     //                    .arready
		output wire [31:0] instruction_tcs1_rdata,       //                    .rdata
		output wire [1:0]  instruction_tcs1_rresp,       //                    .rresp
		output wire        instruction_tcs1_rvalid,      //                    .rvalid
		input  wire        instruction_tcs1_rready,      //                    .rready
		input  wire [12:0] data_tcs1_awaddr,             //           data_tcs1.awaddr
		input  wire [2:0]  data_tcs1_awprot,             //                    .awprot
		input  wire        data_tcs1_awvalid,            //                    .awvalid
		output wire        data_tcs1_awready,            //                    .awready
		input  wire [31:0] data_tcs1_wdata,              //                    .wdata
		input  wire [3:0]  data_tcs1_wstrb,              //                    .wstrb
		input  wire        data_tcs1_wvalid,             //                    .wvalid
		output wire        data_tcs1_wready,             //                    .wready
		output wire [1:0]  data_tcs1_bresp,              //                    .bresp
		output wire        data_tcs1_bvalid,             //                    .bvalid
		input  wire        data_tcs1_bready,             //                    .bready
		input  wire [12:0] data_tcs1_araddr,             //                    .araddr
		input  wire [2:0]  data_tcs1_arprot,             //                    .arprot
		input  wire        data_tcs1_arvalid,            //                    .arvalid
		output wire        data_tcs1_arready,            //                    .arready
		output wire [31:0] data_tcs1_rdata,              //                    .rdata
		output wire [1:0]  data_tcs1_rresp,              //                    .rresp
		output wire        data_tcs1_rvalid,             //                    .rvalid
		input  wire        data_tcs1_rready              //                    .rready
	);
	...
	NIOSV_G_SOC_NIOSV_G_CPU_hart #(
		.RESET_VECTOR             (32'b00000000000100000000000000000000),
		.DBG_EXPN_VECTOR          (32'b00000000100000000000000000000000),
		.CORE_EXTN                (4352),
		.DEBUG_ENABLED            (1),
		...
		.ITCM1_SIZE               (32768),
		.ITCM1_BASE               (32'b00000000100000010000000000000000),
		.ITCM1_INIT_FILE          (""),
		.ITCM2_SIZE               (0),
		...
		.DBG_DATA_S_BASE          (32'b00000000100000000000000000000000),
		.TIMER_MSIP_DATA_S_BASE   (32'b00000000100000011010000000000000),
		.DTCM1_SIZE               (8192),
		.DTCM1_BASE               (32'b00000000100000011000000000000000),
		.DTCM1_INIT_FILE          (""),
		.DTCM2_SIZE               (0),
		...
		.itcs1_awaddr    (instruction_tcs1_awaddr),              //    instruction_tcs1.awaddr
		.itcs1_awprot    (instruction_tcs1_awprot),              //                    .awprot
		.itcs1_awvalid   (instruction_tcs1_awvalid),             //                    .awvalid
		.itcs1_awready   (instruction_tcs1_awready),             //                    .awready
		.itcs1_wdata     (instruction_tcs1_wdata),               //                    .wdata
		.itcs1_wstrb     (instruction_tcs1_wstrb),               //                    .wstrb
		.itcs1_wvalid    (instruction_tcs1_wvalid),              //                    .wvalid
		.itcs1_wready    (instruction_tcs1_wready),              //                    .wready
		.itcs1_bresp     (instruction_tcs1_bresp),               //                    .bresp
		.itcs1_bvalid    (instruction_tcs1_bvalid),              //                    .bvalid
		.itcs1_bready    (instruction_tcs1_bready),              //                    .bready
		.itcs1_araddr    (instruction_tcs1_araddr),              //                    .araddr
		.itcs1_arprot    (instruction_tcs1_arprot),              //                    .arprot
		.itcs1_arvalid   (instruction_tcs1_arvalid),             //                    .arvalid
		.itcs1_arready   (instruction_tcs1_arready),             //                    .arready
		.itcs1_rdata     (instruction_tcs1_rdata),               //                    .rdata
		.itcs1_rresp     (instruction_tcs1_rresp),               //                    .rresp
		.itcs1_rvalid    (instruction_tcs1_rvalid),              //                    .rvalid
		.itcs1_rready    (instruction_tcs1_rready),              //                    .rready
		.dtcs1_awaddr    (data_tcs1_awaddr),                     //           data_tcs1.awaddr
		.dtcs1_awprot    (data_tcs1_awprot),                     //                    .awprot
		.dtcs1_awvalid   (data_tcs1_awvalid),                    //                    .awvalid
		.dtcs1_awready   (data_tcs1_awready),                    //                    .awready
		.dtcs1_wdata     (data_tcs1_wdata),                      //                    .wdata
		.dtcs1_wstrb     (data_tcs1_wstrb),                      //                    .wstrb
		.dtcs1_wvalid    (data_tcs1_wvalid),                     //                    .wvalid
		.dtcs1_wready    (data_tcs1_wready),                     //                    .wready
		.dtcs1_bresp     (data_tcs1_bresp),                      //                    .bresp
		.dtcs1_bvalid    (data_tcs1_bvalid),                     //                    .bvalid
		.dtcs1_bready    (data_tcs1_bready),                     //                    .bready
		.dtcs1_araddr    (data_tcs1_araddr),                     //                    .araddr
		.dtcs1_arprot    (data_tcs1_arprot),                     //                    .arprot
		.dtcs1_arvalid   (data_tcs1_arvalid),                    //                    .arvalid
		.dtcs1_arready   (data_tcs1_arready),                    //                    .arready
		.dtcs1_rdata     (data_tcs1_rdata),                      //                    .rdata
		.dtcs1_rresp     (data_tcs1_rresp),                      //                    .rresp
		.dtcs1_rvalid    (data_tcs1_rvalid),                     //                    .rvalid
		.dtcs1_rready    (data_tcs1_rready),                     //                    .rready
	...
	NIOSV_G_SOC_NIOSV_G_CPU_irq_mapper irq_mapper (
		.clk           (clk),                      //       clk.clk
	...
	NIOSV_G_SOC_NIOSV_G_CPU_irq_mapper irq_mapper_001 (
		.clk           (clk),                          //       clk.clk
		.reset         (reset_reset),                  // clk_reset.reset
	...
	NIOSV_G_SOC_NIOSV_G_CPU_irq_mapper irq_mapper_002 (
		.clk           (clk),                          //       clk.clk
		.reset         (reset_reset),                  // clk_reset.reset
